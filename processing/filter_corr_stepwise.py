## Attempts to filter correlated variables by progressively larger chunks
## Final step includes all remaining columns
## If many columns with little to no correlation, can have memory/time issues
...
try:    
    ...
    sys.exit("python3 filter_corr_stepwise.py feature_file.tab [n_steps=5] [corr_cutoff=0.95]")
